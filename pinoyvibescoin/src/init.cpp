...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pinoyvibescoin-project/pinoyvibescoin>";
    const std::string URL_WEBSITE = "<https://pinoyvibescoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Pinoyvibescoin version %s\n", FormatFullVersion());
}
