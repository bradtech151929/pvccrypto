...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pinoyvibescoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pinoyvibescoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pinoyvibescoin transaction") + "\n" +
              "  pinoyvibescoin-tx [options] -create [commands]   " + _("Create hex-encoded pinoyvibescoin transaction") + "\n" +
              "\n";
