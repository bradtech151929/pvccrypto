...
{
    const char* pszTimestamp = "18/June/2021 Sigaw sa pugad lawin";
    const CScript genesisOutputScript = CScript() << ParseHex("151984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1624062524, 2000284375, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe8f64291a9f8ef7b61488d24868d7c9e192a7f1935720e3eb34424f0e6739764"));
        assert(genesis.hashMerkleRoot == uint256S("0x0b6de2fffd8ad64c863e3d0849a754a22114d4b82f9115f3f8da18bd3c3ee4d3"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("18.116.150.151", "18.116.150.151", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("pinoyvibescointools.com", "dnsseed.pinoyvibescointools.com"));
        //vSeeds.push_back(CDNSSeedData("pinoyvibescoinpool.org", "dnsseed.pinoyvibescoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xe8f64291a9f8ef7b61488d24868d7c9e192a7f1935720e3eb34424f0e6739764"))
        ...
        chainTxData = ChainTxData{
            ...
            1624062524, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1624062524, 130333, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6e24b502c93ba85099635375538feaae6412363ff6ff48209163852f279cffda"));
        assert(genesis.hashMerkleRoot == uint256S("0x0b6de2fffd8ad64c863e3d0849a754a22114d4b82f9115f3f8da18bd3c3ee4d3"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("18.116.150.151", "18.116.150.151"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.pinoyvibescoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x6e24b502c93ba85099635375538feaae6412363ff6ff48209163852f279cffda")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1624062524, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x03f7f0f0b6159cc7ba74120dd6de1aadb20ec670d962e9a37743adc4ead340c8"));
        assert(genesis.hashMerkleRoot == uint256S("0x0b6de2fffd8ad64c863e3d0849a754a22114d4b82f9115f3f8da18bd3c3ee4d3"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x03f7f0f0b6159cc7ba74120dd6de1aadb20ec670d962e9a37743adc4ead340c8"))
        };
